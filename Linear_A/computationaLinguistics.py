...
# -----------------------------
# 1. Load Words from Cleaned CSV (BaseSheet_CLEANED.csv)
# -----------------------------
csv_path = "/Users/joslinishimwe/Documents/Spring2025/computationalLingustics/FinalProject/BaseSheet_CLEANED.csv"
csv_df = pd.read_csv(csv_path)

# Filter valid syllabified words (hyphenated, no brackets or plus signs)
linear_a_words = [
    word.strip()
...
# Threshold for annotating values
...
plt.title("Linear A Syllable Transition Matrix (Cleaned CSV-Based)")
